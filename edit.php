...
<label for="user"><span style="font-size: 150%; font-family: MS Office Symbol Extralight;">Title For Post</span></label>
  <textarea id="user" class="md-textarea form-control area" rows="3" placeholder="Title For Post" name="head">
  	<?php
echo $row['head'];
?>
  </textarea>
...
<div class="form-group">
<label for="user"><span style="font-size: 150%; font-family: MS Office Symbol Extralight;">Post Content</span></label>
